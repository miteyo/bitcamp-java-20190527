// v45_2 : Mybatis의 DAO 구현체 자동 생성기 이용하기 (BoardxxxxCommand에만 적용 (command생성자 변경))
  ...
  public App() throws Exception {
    ...
    try {
      ...
      sqlSessionFactory =  new SqlSessionFactoryProxy(
          new SqlSessionFactoryBuilder().build(inputStream)); //SqlSessionFactoryProxy에 담는다.
   ...
   // 트랜잭션 관리자를 준비한다.
      ...
      BoardDao boardDao = daoFactory.createDao(BoardDao.class); // BoardDao 구현체 하나 만들어줘
