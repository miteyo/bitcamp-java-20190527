...
CREATE TABLE teacher (
  ...
  photo_id   VARCHAR(255) NOT NULL COMMENT '사진', -- 사진
...
CREATE TABLE centers (
  ...
  det_addr  VARCHAR(13)  NOT NULL COMMENT '상세주소' -- 상세주소
)
COMMENT '교육센터';
...
CREATE TABLE subjects (
  ...
  tilte      VARCHAR(25) NOT NULL COMMENT '과목명' -- 과목명
)
COMMENT '강의과목';
...
-- 강사
ALTER TABLE teacher
  ADD CONSTRAINT FK_members_TO_teacher -- 회원 -> 강사
    FOREIGN KEY (
      teacher_id -- 강사번호
    )
    REFERENCES members ( -- 회원
...
-- 강사강의과목
ALTER TABLE teacher_subject
  ADD CONSTRAINT FK_teacher_TO_teacher_subject -- 강사 -> 강사강의과목
    FOREIGN KEY (
      teacher_id -- 강사번호
    )
...
-- 강사강의배정
ALTER TABLE lecture_teacher
  ADD CONSTRAINT FK_teacher_TO_lecture_teacher -- 강사 -> 강사강의배정
    FOREIGN KEY (
      teacher_id -- 강사번호
    )
    REFERENCES teacher ( -- 강사
