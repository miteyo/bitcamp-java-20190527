// 바이너리 데이터 입출력 - FileOutputStream 클래스 사용법 (출력)
...
public class Test01_1 {
  public static void main(String[] args) throws Exception {
    ...
    FileOutputStream out = new FileOutputStream("data.bin"); // 문자열로 폴더생성
    ...
    out.write(102);
    out.write(127);
    out.write(287454020); // 00010001 00100010 00110011 01000100
