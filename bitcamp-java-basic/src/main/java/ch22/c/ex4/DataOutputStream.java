...
public class DataOutputStream extends DecoratorOutputStream {
  ...
  //프리머티브타입의 값을 출력하는 값을 캡슐하여 별도의 클래스로 정의한다.
  ...
  public void writeUTF(String str) throws IOException {
    ...
    // 먼저 출력할 바이트의 개수를 쓴다.
    // 문자열을 출력할 때 한번에 32767바이트만 출력하게 한다.
    writeShort(bytes.length);

    // 그리고 문자열의 UTF-8의 코드값이 들어 있는 바이트 배열을 출력한다.
    write(bytes);
  }
