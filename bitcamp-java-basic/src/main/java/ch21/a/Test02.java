...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    try {
    ...
    } catch (Error err) { //Error 타입, Error의 자식도 가능. (시스템에러, 만약에 try 실행하다 시스템 에러가 발생하면 그 에러를 파라미터로 받고
      // 예외가 발생하면 이 블록이 실행된다.
      ...
      //시스템 예외가 발생했으면 적절한 조취를 취한 후, 바로 종료하라!
      return; //메인 메소드 종료! 종료 안하면 아래의 add를 또 실행가능.
    }
