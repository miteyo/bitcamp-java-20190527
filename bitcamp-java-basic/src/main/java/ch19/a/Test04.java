...
public class Test04 {
  ...
  public static void main(String[] args) {
    ...
    //
    Car obj2 = new Car() { // 익명클래스에 Car 상속하기 () => 수퍼클래스의 생성자호출
      @Override
      public void run() {
    ...
    Car obj3 = new Car("티코") { //Car를 상속받아 run 오버라이딩하고, 문자열을 받는 생성자를 호출한다.
      @Override
      public void run() {
    ...
    // Pen obj4 = new class ? extends Object implements Pen() {
    Pen obj4 = new Pen() { //() 수퍼클래스의 기본 생성자는 => 기본적으로 오브젝트
      @Override
      public void write() {
    ...
    //주의! 
    // => 수퍼클래스와 인터페이스를 동시에 지정하여 익명 클래스를 만들 수 없다.
  ...
  public static void m1() {
    //다른 메서드에 (예: main) 정의된 로컬클래스를 사용할 수 없다.
   A obj = new A(); //컴파일 에러!
