...
// 기존에 작성한 클래스를 새 규격에 맞춰 재활용 할 수 있게 만드는 설계기법! -> 어댑터 만들기
public class Printer2Adapter implements Printer2 {
  
  // 이 클래스는 중간에서 Printer2에 꼽을 수 있도록 중계해주는 역할만 하기 때문에
  // 이 클래스가 직접 Printer 기능을 구현해서는 안된다.
...
@Override
  public void print(String text) {
    ...
    // 아답터에게 print() 라는 명령을 내리면, 생성자에서 받은 기존 프린터 객체를 실행시킨다.
