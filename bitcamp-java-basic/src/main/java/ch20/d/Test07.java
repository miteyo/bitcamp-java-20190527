...
public class Test07 {
  ...
  public static void main(String[] args) {
    ...
    Iterator<String> iterator = keySet.iterator(); // key가 들어있는 창고에서 한개씩 값을 뽑아내는 것

    System.out.println(iterator.next()); // key 중 한개가 나온다 (순서 ㄴㄴ
    System.out.println("-----------------------------------");
    ...
    //다음과 같이 key가 들어 있는 목록에서 key를 꺼내 줄 Iterator를 다시 리턴 받아야 한다.
