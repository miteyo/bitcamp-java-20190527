...
public class Test12_2 {
  ...
  // 인스턴스를 복제할 수 있게 하려면
  // => Object에서 상속 받은 clone()을 오버라이딩해야한다.
  ...
  static class Score {
    ...
    public Score clone() throws CloneNotSupportedException {
      ...
      // 그냥 상속 받은 메서드를 오버라이딩하고, 접근권한을 public으로 확대한다.
      // 리턴타입은 해당클래스 이름으로 변경한다.  //원래는 public Object clone()
...
//    이유? clone() 메소드의 사용을 활성화 시키지 않아서 예외가 발성한 것이다.
